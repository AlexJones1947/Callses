...
public class CallReceiverTemp extends PhoneCallReceiver {
    Context mContext;
    ...
    protected void onIncomingCallStarted(final Context ctx, String number, final Date start, int state) {
        ...
        if(!sTemp) {
            sTemp = true;
            CallessUtils.v(" Phone Call Sate IncomingCall Started 33 " + state);
   ...
   /* public void acceptCall() {
    ...
    public void callAnswerView(Context ctx, String number, String name) {
        ...
        CallessUtils.v(" Phone Call Sate IncomingCall Started 44 " +sTemp);
